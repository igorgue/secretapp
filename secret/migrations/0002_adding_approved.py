...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Secret.approved'
        db.add_column('secret_secret', 'approved', orm['secret.secret:approved'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Secret.approved'
        db.delete_column('secret_secret', 'approved')
