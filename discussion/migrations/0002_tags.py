...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discussion.tags'
        db.add_column('discussion_discussion', 'tags', orm['discussion.discussion:tags'])
        
        # Changing field 'Discussion.text'
        # (to signature: django.db.models.fields.TextField(null=True, blank=True))
        db.alter_column('discussion_discussion', 'text', orm['discussion.discussion:text'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Discussion.tags'
        db.delete_column('discussion_discussion', 'tags')
