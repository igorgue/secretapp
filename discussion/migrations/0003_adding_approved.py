...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discussion.approved'
        db.add_column('discussion_discussion', 'approved', orm['discussion.discussion:approved'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Discussion.approved'
        db.delete_column('discussion_discussion', 'approved')
