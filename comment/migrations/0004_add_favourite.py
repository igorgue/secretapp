...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('comment_favouritesecret', (
            ('id', orm['comment.FavouriteSecret:id']),
            ('created_by', orm['comment.FavouriteSecret:created_by']),
            ('deleted_by_id', orm['comment.FavouriteSecret:deleted_by_id']),
            ('created_at', orm['comment.FavouriteSecret:created_at']),
            ('updated_at', orm['comment.FavouriteSecret:updated_at']),
            ('deleted_at', orm['comment.FavouriteSecret:deleted_at']),
            ('deleted', orm['comment.FavouriteSecret:deleted']),
            ('ip', orm['comment.FavouriteSecret:ip']),
            ('secret', orm['comment.FavouriteSecret:secret']),
        ))
        db.send_create_signal('comment', ['FavouriteSecret'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('comment_favouritesecret')
