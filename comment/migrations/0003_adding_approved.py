...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DiscussionComment.approved'
        db.add_column('comment_discussioncomment', 'approved', orm['comment.discussioncomment:approved'])
        
        # Adding field 'SecretComment.approved'
        db.add_column('comment_secretcomment', 'approved', orm['comment.secretcomment:approved'])
        
        # Adding field 'ProposalComment.approved'
        db.add_column('comment_proposalcomment', 'approved', orm['comment.proposalcomment:approved'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'DiscussionComment.approved'
        db.delete_column('comment_discussioncomment', 'approved')
        
        # Deleting field 'SecretComment.approved'
        db.delete_column('comment_secretcomment', 'approved')
        
        # Deleting field 'ProposalComment.approved'
        db.delete_column('comment_proposalcomment', 'approved')
